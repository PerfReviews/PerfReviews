...
date: "2020-05-20"
summary: In this post we present several ways of assessing the potential performance gains before implementing improvements. This will help building the case and prioritizing performance work.
...
![Plotting Conversion Rate for each First Paint Category (good, average, slow)](/images/blog/thumbs/assess-performance-impact_simplified-first-paint-cr.png)
...
![Plotting Revenue per session for a specific device (iPhone 8) depending on FPS after click](/images/blog/thumbs/assess-performance-impact_simplified-iphone8-dollar-per-session.png)
...
![Explanation of Relative mobile conversion rate and its components](/images/blog/thumbs/assess-performance-impact_rel-mcvr.png)
...
![Screenshot of Google's Test My Site page](/images/blog/thumbs/assess-performance-impact_test-my-site.png)
...
![Calculating potential increase in annual revenue using Google's Test My Site](/images/blog/thumbs/assess-performance-impact_test-my-site-potential-revenue.png)
