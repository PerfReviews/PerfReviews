...
date: "2021-04-17"
summary: Cómo afectan las Core Web Vitals a tu web, medir las nuevas métricas y optimizarlas.
featuredImage: /images/blog/thumbs/core-web-vitals-detail.png
---

# Core Web Vitals de Google, cómo afecta a SEO y qué hacer en tu web
