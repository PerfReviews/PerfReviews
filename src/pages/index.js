  ...
  render() {
    ...
    return (
      <Layout location={this.props.location} title={siteTitle}>
        <SEO
          title="Auditorías de rendimiento web"
        ...
        <p>
          Tenemos una larga experiencia llevando a cambio mejoras en el
          rendimiento de webs y estudiando el impacto en las métricas de negocio
          que te preocupan. Sabemos cuál es el balance entre esfuerzo técnico y
          retorno de la inversión.
        </p>
        <p>
          Hemos desarrollado proyectos web a escala en empresas como Facebook,
          Spotify, Mediaset, Infojobs, Coches.net, Tuenti y Mil Anuncios. Con un
          especial énfasis en usabilidad y rendimiento.
        </p>
        <p>
          Tenemos el reconocimiento de Google como{" "}
          <a href="https://developers.google.com/community/experts">
            Google Developer Experts
          </a>{" "}
          en tecnologías web y Media Developer Expert por Cloudinary.
        </p>
        <p
          style={{
        ...
        >
          <div style={{ width: "33%" }}>
            <img
              alt="Spotify logo"
              src={spotifyLogo}
              style={{ marginBottom: 0, padding: "1em", display: "block" }}
            />
          </div>
          <div style={{ width: "33%" }}>
            <img
        ...
        <p>
          El rendimiento de tu sitio web es muy importante. Una web que carga
          rápido en cualquier dispositivo y condiciones de red mejora las
          métricas clave de negocio. Trabajaremos contigo y tu equipo para
          identificar los principales problemas que afectan a la performance de
          tu web.
        </p>

        <p>
          Una vez realizado el estudio proporcionaremos un documento detallado
          con consejos para ayudar al equipo de desarrollo a mejorar tanto el
          rendimiento como la experiencia de usuario de tu web.
        </p>

        <h4>Nuestro proceso</h4>
        <ol style={{ marginLeft: "2em" }}>
          <li>
            Todo empieza con una llamada. Juntos estableceremos{" "}
            <strong>las mejoras y objetivos deseados</strong>.
          </li>
          <li>
            Proporcionaremos un informe detallado del rendimiento, incluyendo{" "}
            <strong>soluciones concretas</strong>, listo para pasárselo a tu
            equipo de desarrollo.
          </li>
          <li>
            Planificaremos <strong>2 reuniones de seguimiento</strong> de una
            hora de duración para asegurarnos de que estamos haciendo progresos.
          </li>
        </ol>

        <h4>Reserva tu análisis de rendimiento</h4>
        {/* <p> */}
        {/*   <span style={{ color: "var(--textColorLink)", fontWeight: "bold" }}> */}
        {/*     795 € */}
        {/*   </span> */}
        ...
        <p style={{ marginBottom: "4em" }}>
          <strong>
            <a
              style={{
                padding: "0.5em 1em",
                backgroundColor: "var(--textColorLink)",
                color: "#fff",
              }}
              href="mailto:mail@perf.reviews?subject=Perf Review"
            >
              Contrata nuestro servicio de análisis
            </a>
          </strong>
        </p>
        ...
        <p>
          Aprende cuáles son los principales problemas de rendimiento en sitios
          web, cómo corregirlos y monitorizarlos.
        </p>
        <p style={{ marginBottom: "4em" }}>
          <strong>
            <a
              ...
              href="mailto:mail@perf.reviews?subject=Información Worlshops"
            >
              Contáctanos para condiciones
            </a>
          </strong>
        </p>
        ...
        <h3>In English</h3>
        <p>
          <Link to="/en/services/">Read about our services</Link>
        </p>
